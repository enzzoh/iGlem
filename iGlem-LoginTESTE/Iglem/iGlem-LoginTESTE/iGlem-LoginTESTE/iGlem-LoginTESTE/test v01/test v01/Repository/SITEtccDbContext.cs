...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => //optionsBuilder.UseSqlServer("Data Source=.\\SENAI;Initial Catalog=DATAtcc;User ID=sa;Password=senai.123;TrustServerCertificate=True");
            optionsBuilder.UseSqlServer("Data Source=PCDENINHO;Initial Catalog=DATAtcc;Integrated Security=True;Encrypt=False;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Documento>(entity =>
        {
            ...
            .Property(d => d.conteudodocumento)  
            .HasColumnName("conteudodocumento");
