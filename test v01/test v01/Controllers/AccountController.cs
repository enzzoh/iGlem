...
using test_v01.Repository.Models; // O contexto do banco de dados
...
namespace AccountContoller.Controllers
{
    public class AccountController : Controller
    {
		...
		public async Task<IActionResult> Register([Bind("Idusuario,Emailusuario,Senhausuario,Nomeusuario")] Usuario usuario)
		{
